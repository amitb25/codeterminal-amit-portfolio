...
const faqs = [
  { q: "What technologies do you work with?", a: "I specialize in the MERN stack — MongoDB, Express.js, React, and Node.js. I also work with Laravel, Next.js, PostgreSQL, TypeScript, and AI tools like Claude, Cursor, and Antigravity." },
          ...
          {faqs.map((faq, i) => (
            ...
            >
              ...
              >
                ...
                >
                  {openIndex === i ? <Minus color="#A6FF00" size={20} /> : <Plus color="#666" size={20} />}
                </motion.div>
              </button>
              <AnimatePresence>
                {openIndex === i && (
                  ...
                  >
                    <p style={{ color: '#A1A1A1', paddingBottom: '30px', lineHeight: 1.7 }}>{faq.a}</p>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
